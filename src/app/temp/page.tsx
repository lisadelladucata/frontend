        ...
        <div className="bg-[#49A947] -mt-1">
          ...
          <div className="p-5">
            <p className="text-[#FDFDFD]">
              <span className="font-medium">NEW:</span> The device is in perfect
              condition and has no signs of wear or scratches. Its functionality
              is equivalent to a factory- fresh item, responsiveness to commands
              is instantaneous, and it does not have any overheating issues.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="p-5">
              <p className="text-[#FDFDFD]">
                <span className="font-medium"> NEW:</span> The device is in
